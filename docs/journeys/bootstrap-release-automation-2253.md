...
- **Should feel:** An explicit, deliberate override — not a silent guess. An unreadable or version-less `--extra-file`, or an unrecognized `--release-type`, fails loud (a thrown error / usage error) rather than quietly seeding `0.1.0`.
