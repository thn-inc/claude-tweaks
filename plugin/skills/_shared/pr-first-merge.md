...
## Step 4 and Step 5: post-merge (outcome `merged` only)
...
Step 4's post-merge reconcile (release-carrier tracking via tag ancestry, Step 4.1,
then `bin/hooks.js reconcile`) and Step 5's
