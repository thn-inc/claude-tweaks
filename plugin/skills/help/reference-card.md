...
| `/claude-tweaks:feedback` | Route a learning upstream to the claude-tweaks plugin — defect or gap. | `[<learning text>] [--kind=defect\|gap] [--dry-run] [--queue] [--full] [--pre-confirmed]` |
